...
<div className={C('code-box', { active: this.state.previewUrl.endsWith('/at_city_selector') })} onClick={this.onCodeClick.bind(null, '/at_city_selector')}><header>基本使用</header><div className="bd"><pre className="language-tsx"><code className="language-tsx" dangerouslySetInnerHTML={{__html: `<span class="token keyword">import</span> <span class="token operator">*</span> <span class="token keyword">as</span> React <span class="token keyword">from</span> <span class="token string">'react'</span>
