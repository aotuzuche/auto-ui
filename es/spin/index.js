...
var Spin = function Spin(props) {
  var css = cn('x-loading__spin', props.className);
  ...
  var loadingSpin = React.createElement("div", _extends({}, domprops, {
    className: css
  ...
  if (props.text) {
    var _css = cn('x-spin', props.className);

    var _domprops = ignore(props, ['text']);
