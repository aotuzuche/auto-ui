...
(function (_PureComponent) {
  ...
  _proto._content = function _content() {
    let css = cn('x-dialog', this.props.className)
    let domprops = ignore(this.props, ['onBgClick', 'visible', 'height'])
...
let Scroller = function Scroller(props) {
  let css = cn('x-dialog__scroller', props.className)
